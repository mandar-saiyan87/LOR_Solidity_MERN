    ...
    return (
        <>
            ...
            <form onSubmit={handleLogin}>
                ...
                <p className="text-slate-600 text-sm mt-6 text-center">Don't have an account? <span className="text-blue-600 font-medium hover:underline ml-1 cursor-pointer" onClick={() => setShowLogin(false)}>Register Here</span></p>
            </form >
